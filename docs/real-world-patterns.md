...
`cargo fm -p package-name` when one member owns the public feature API.
...
produce confusing behavior or duplicate integration APIs.
...
Private entries stay out of public output while remaining documented for
maintainers.
